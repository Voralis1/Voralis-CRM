...
export type Role = "admin" | "affiliate" | "media_buyer";

// Page d'accueil selon le rôle (utilisée pour rediriger après connexion).
export function homeForRole(role: string | null | undefined): string {
  if (role === "admin") return "/admin/dashboard";
  if (role === "media_buyer") return "/media-buying";
  return "/panel"; // affiliate par défaut
}
